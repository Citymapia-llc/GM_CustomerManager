...
s_a[252]="Bulawayo|Harare|ManicalandMashonaland Central|Mashonaland East|Mashonaland West|Masvingo|Matabeleland North|Matabeleland South|Midlands";
 ...
 function populateStates(countryElementId, stateElementId) {
	...
	selectedCountryIndex = (selectedCountryIndex === 0) ? 105 : selectedCountryIndex;
 ...
 function populateCountries(countryElementId, stateElementId){
   ...
   // countryElement.selectedIndex = 0;
	...
	countryElement.options[0] = new Option('India','India');
	 ...
	 countryElement.options[0].setAttribute("selected", "selected");
...
function populateStatesEdit(countryElementId, stateElementId, StateValue) {
    var selectedCountryIndex = document.getElementById(countryElementId).selectedIndex;
    var stateElement = document.getElementById(stateElementId);

    stateElement.length = 0;	// Fixed by Julian Woods
     stateElement.options[0] = new Option(StateValue, StateValue);
    stateElement.selectedIndex =0;
	selectedCountryIndex = (selectedCountryIndex === 0) ? 105 : selectedCountryIndex;
    var state_arr = s_a[selectedCountryIndex].split("|");
